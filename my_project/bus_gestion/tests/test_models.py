...
class TestBus:
 	def test_model(self):
 		obj=mixer.blend('bus_gestion.Bus', nom_bus='bus1', numero_matricule=35478, numero_ligne=3, nombre_place=60, id_ecran='23-ff-58-90', status_ecran='O')
 	...
 	def test_modify(self):
 		...
 		obj=mixer.blend('bus_gestion.Bus', numero_matricule=35478)
...
class TestDriver:
	...
	def test_Chauffeur(self):
		obj=mixer.blend('bus_gestion.Driver', name='last name', surname='first name', tel=771710292)
	...
	def test_delete(self) :
 		...
 		obj=mixer.blend('bus_gestion.Driver', mame='last name')
 		req=obj.delete()
